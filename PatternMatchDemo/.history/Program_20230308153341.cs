    ...
    class Program
    {
        static void Main(string[] args)
        {
          ...
          // make a call to TrySplit
            first = message.AsSpan().TrySplit(new[] {'' }, StringSplitOptions.RemoveEmptyEntries);
            second = first.AsSpan().Split(new[] {'' }, StringSplitOptions.RemoveEmptyEntries);
            third = second.AsSpan().Split(new[] {'' }, StringSplitOptions.RemoveEmptyEntries);
