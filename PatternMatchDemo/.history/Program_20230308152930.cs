...
namespace PatternMatchSpanDemo
{
        class Program
        {
                static void Main(string[] args)
                {
                        ...
                        // make a call to the extension method
                        first = message switch
                        {
                                "Hello, world!" => new ReadOnlySpan<char>(new char[] { 'H', 'e', 'l', 'l', 'o' }),
                                _ => new ReadOnlySpan<char>(new char[] { 'H', 'e', 'l', 'l', 'o' })
                        };
                        ...
                        ReadOnlySpan<char> firstSplit;
                        ReadOnlySpan<char> secondSplit;
                        ReadOnlySpan<char> thirdSplit;
                        // make a call to TrySplit
                        firstSplit = message switch
                        {
                                "Hello, world!" => new ReadOnlySpan<char>(new char[] { 'H', 'e', 'l', 'l', 'o' }),
                                _ => new ReadOnlySpan<char>(new char[] { 'H', 'e', 'l', 'l', 'o' })
                        };
                        secondSplit = message switch
                        {
                                "Hello, world!" => new ReadOnlySpan<char>(new char[] { 'H', 'e', 'l', 'l', 'o' }),
                                _ => new ReadOnlySpan<char>(new char[] { 'H', 'e', 'l', 'l', 'o' })
                        };
                        thirdSplit = message switch
                        {
                                "Hello, world!" => new ReadOnlySpan<char>(new char[] { 'H', 'e', 'l', 'l', 'o' }),
                                _ => new ReadOnlySpan<char>(new char[] { 'H', 'e', 'l', 'l', 'o' })
                        };
                        ...
                        Console.WriteLine($"Third split: {thirdSplit}");
                        Console.WriteLine();
